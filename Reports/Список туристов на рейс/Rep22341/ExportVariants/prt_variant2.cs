...
{
    [DisplayName("Вариант2")]
    [DefaultValue(VariantsEXType.SplitPartner)]
    public class prt_variant2 : IprtClass
    {
        ...
        public override void Start(IQueryable<ExportItem> exportItems, bool SplitPartner)
        {
                ...
                .ThenBy(x => x.FNameLat))
            {
                ...
                ec.SetCellValue(2, lineOut, q.NameLat.ReplaceAnalogChar() + "/" + q.FNameLat.ReplaceAnalogChar() + " " + q.Turist.SexFull);
